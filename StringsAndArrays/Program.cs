namespace StringsAndArrays
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            conatinsWorld = helloWorld.Contains("World");
            ...
            if (conatinsWorld)
            {
                ...
                Console.WriteLine("The word 'World' starts at index: " + index);
            }
            else
            {
                Console.WriteLine("The word 'World' is not found in the string.");
            }
            ...
            Console.WriteLine("Third item in the array: " + numbers[2]);
            ...
            Console.WriteLine("Words from helloWorld: " + string.Join(", ", words));
        }
    }
}
